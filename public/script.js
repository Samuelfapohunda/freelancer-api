...
!(function (a, b) {
    ...
    function (a, b) {
      ...
      (n.fn = n.prototype =
        ...
        n.extend({
          expando:
            'jQuery' + (m + Math.random()).replace(/\D/g, ''),
          isReady: !0,
          error: function (a) {
            throw new Error(a);
          },
          ...
          isNumeric: function (a) {
            var b = a && a.toString();
            return (
              !n.isArray(a) && b - parseFloat(b) + 1 >= 0
            );
          },
      ...
      !(function () {
        ...
        (a.innerHTML =
          ...
          (l.htmlSerialize =
            !!a.getElementsByTagName('link').length),
          (l.html5Clone =
            '<:nav></:nav>' !==
        ...
        for (
          ...
          if (((g = a[r]), g || 0 === g))
            if ('object' === n.type(g))
              ...
              (i =
                i || p.appendChild(b.createElement('div'))),
                (j = ($.exec(g) || [
                  '',
                  '',
                ])[1].toLowerCase()),
      ...
      function Da(a) {
        return (
          (a.type =
            (null !== n.find.attr(a, 'type')) + '/' + a.type),
          a
        );
      }
      function Ea(a) {
        ...
        return (
          c ||
            ...
            ('none' !== c && c) ||
              ...
              (b = (
                Ja[0].contentWindow || Ja[0].contentDocument
              ).document),
              b.write(),
              b.close(),
              (c = La(a, b)),
      ...
      function fb(a, b, c) {
        ...
        if (0 >= e || null == e) {
          if (
            ...
            return e;
          (d =
            g && (l.boxSizingReliable() || e === a.style[b])),
            (e = parseFloat(e) || 0);
        }
        return (
          e +
          eb(a, b, c || (g ? 'border' : 'content'), d, f) +
          'px'
        );
      }
      n.extend({
        ...
        ajax: function (b, c) {
          ...
          if (
            ...
            (l.url = ((b || l.url || Rb) + '')
              ...
              .replace(Mb, Sb[1] + '//')),
            (l.type =
              c.method || c.type || l.method || l.type),
            (l.dataTypes = n
              .trim(l.dataType || '*')
              .toLowerCase()
              .match(G) || ['']),
      ...
      (n.param = function (a, b) {
        ...
        if (
          (void 0 === b &&
            (b =
              n.ajaxSettings && n.ajaxSettings.traditional),
          ...
          return h || 'jsonp' === b.dataTypes[0]
            ? ((e = b.jsonpCallback =
              ...
              (b.converters['script json'] = function () {
                return (
                  g || n.error(e + ' was not called'), g[0]
                );
              }),
              (b.dataTypes[0] = 'json'),
              (f = a[e]),
          ...
          position: function () {
            if (this[0]) {
              ...
              return (
                ...
                {
                  top:
                    b.top - c.top - n.css(d, 'marginTop', !0),
                  left:
                    b.left -
                    c.left -
   ...
   * Licensed under the MIT license*/ if (
  ...
  +(function (a) {
    ...
    +(function (a) {
      ...
      (d.VERSION = '3.3.7'),
        ...
        (d.prototype.addAriaAndCollapsedClass = function (
          a,
          b
        ) {
          var c = a.hasClass('in');
    ...
    +(function (a) {
      ...
      (c.VERSION = '3.3.7'),
        ...
        (c.prototype.init = function (b, c, d) {
          if (
            ...
            this.$element[0] instanceof
              document.constructor && !this.options.selector)
          )
            throw new Error(
        ...
        (c.prototype.fixTitle = function () {
          ...
          (a.attr('title') ||
            'string' !=
              typeof a.attr('data-original-title')) &&
            a
              .attr(
                'data-original-title',
                a.attr('title') || ''
        ...
        (c.prototype.getCalculatedOffset = function (
          a,
          b,
          c,
          d
        ...
        (c.prototype.getViewportAdjustedDelta = function (
          a,
          b,
          c,
          d
      ...
      (b.VERSION = '3.3.7'),
        ...
        (b.prototype.process = function () {
          var a,
            ...
            g = this.activeTarget;
          if (
            (this.scrollHeight != c && this.refresh(), b >= d)
          )
            return (
              g != (a = f[f.length - 1]) && this.activate(a)
            );
          if (g && b < e[0])
    ...
    +(function (a) {
      ...
      (c.VERSION = '3.3.7'),
        ...
        (c.prototype.checkPositionWithEventLoop =
          function () {
            ...
            if (this.affixed != h) {
              ...
              (this.affixed = h),
                ...
                this.$element
                  ...
                  .addClass(i)
                  .trigger(
                    i.replace('affix', 'affixed') +
                      '.bs.affix'
                  );
            }
            'bottom' == h &&
              this.$element.offset({ top: g - b - f });
          }
        });
      var d = a.fn.affix;
      (a.fn.affix = b),
